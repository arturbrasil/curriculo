...
function getMenuPopupHost(options, trigger_elmnt) {
        ...
        if (options.hasGoTo) {
                ...
                ;
                 // Winbox link
                var url = new Curl('portal.php', false);
                url.setArgument('app', 'mikrotik');
                url.setArgument('hostid', options.hostid);
                winbox.url = url.getUrl();

                    // WinMTR link
                var url = new Curl('portal.php', false);
                url.setArgument('app', 'winmtr');
                url.setArgument('hostid', options.hostid);
                winmtr.url = url.getUrl();

                     // putty link
                var url = new Curl('portal.php', false);
                url.setArgument('app', 'puttyssh');
                url.setArgument('hostid', options.hostid);
                puttyssh.url = url.getUrl();
