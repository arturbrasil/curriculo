(function(){
	...
	myResume.controller('MyCtrl', function($scope, myResumeData, mailManager, timelineManager){
		...
		// Style management
		var labelClassName = ['', 'label-success', 'label-warning', 'label-inverse', 'label-info', 'label-important', 'label-success', 'label-warning', 'label-inverse', 'label-info', 'label-important', 'label-success', 'label-warning', 'label-inverse', 'label-info', 'label-important', 'label-success', 'label-warning', 'label-inverse', 'label-info', 'label-important', 'label-success', 'label-warning', 'label-inverse', 'label-info', 'label-important', 'label-success', 'label-warning', 'label-inverse', 'label-info', 'label-important'];
